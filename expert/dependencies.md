...
Более подробно можно ознакомиться в `package.json` файле в корневой папке проекта.

::: details Окружение

- **Typescript** <Badge type="tip" text="~5.8.3" /> - язык программирования
- **Node.js** <Badge type="tip" text="~22.16.0" /> - серверная среда выполнения JS кода
...
- **Tailwind CSS** <Badge type="tip" text="^4.1.8" /> - стилизация компонентов
- **Radix UI** <Badge type="tip" text="^1.1.14" /> - использование готовых компонентов
